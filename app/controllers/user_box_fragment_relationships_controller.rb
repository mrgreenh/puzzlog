class UserBoxFragmentRelationshipsController < ApplicationController
  ...
  def create
     ...
     if current_user.user_box_fragment_relationships.create(resource_id:@fragment.id,bag_id:bag_id)
       if bag_id.to_i>-1
       ...
       flash[:errors] = "There has been a problem placing this in your puzzlebox!"
       @current_bag_id="none"
     end
